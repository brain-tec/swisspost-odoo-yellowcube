...
class test_issue_log(common.TransactionCase):
    ...
    def test_issues(self):
        ...
        ret = self.connect.log_issue('test message using variables: {x} {log_errors}', context=ctx, x=314)
        ...
        ret = self.connect.log_issue('test message for the model {active_model}', context=ctx)
