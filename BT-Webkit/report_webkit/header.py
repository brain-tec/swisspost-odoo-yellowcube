...
class HeaderHTML(osv.osv):
    ...
    _columns = {
        ...
        # These two values only work if format == Customize
        'page_width': fields.float('Page Width'),
        'page_height': fields.float('Page Heigth'),
        ...
        'format': fields.selection(
                ...
                ('Customize','Customization (Select width and height)'),
                ],
                'Paper size',
                required=True,
                help="Select Proper Paper size"
        ),
        'use_default_webkit_path': fields.boolean('Use webkit_path from params to generate the report', 
                                                  help="True -> uses webkit_path / False -> uses webkit_path_financial_reports"),
    }
    
    _defaults = {  
        'use_default_webkit_path': lambda *a: True,
    }
