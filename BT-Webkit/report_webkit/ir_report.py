...
class ReportXML(osv.osv):
    ...
    _columns = {
        ...
        'direct_print' : fields.boolean('Direct Print', help="Directly Prints to the printer"),
        'alternative_print' : fields.boolean('Alternative Tray for Child', help="Prints the child report from the alternative tray"),
        'child_report': fields.many2one('ir.actions.report.xml', 'Child Report', required=False),
        ...
        'one_document':fields.boolean('One document', help='This mode prints every record on an unique document.'),
    }
