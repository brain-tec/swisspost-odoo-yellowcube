...
class stock_picking_ext(osv.osv):
    ...
    def get_file_name_barcode(self, cr, uid, ids, context=None):
        ...
        file_name = 'barcode_label_{0}_spo{1}.pdf'.format(stock_picking.origin, stock_picking.id)
        return file_name
    ...
    def get_different_packages(self, cr, uid, ids, context=None):
        ...
        for line in picking.move_lines:
            if line.tracking_id:
                different_packages.add(line.tracking_id.id)

        return list(different_packages)
