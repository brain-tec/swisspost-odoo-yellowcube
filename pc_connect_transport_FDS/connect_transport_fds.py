...
from openerp.addons.pc_connect_transport_localsftp.connection_sftp import connection_sftp


class connect_transport_fds(osv.Model):
    _inherit = 'connect.transport.localsftp'
    _name = 'connect.transport.fds'
