...
from openerp.addons.pc_account_pf.report.account_invoice_report_ext import \
    account_invoice_report_ext
from openerp.addons.report_webkit import report_sxw_ext
from openerp.tools.translate import _


class invoice_followup_report_ext(account_invoice_report_ext):
...
delete_report_from_db('invoice_followup_report_pf')
report_sxw_ext.report_sxw_ext('report.invoice_followup_report_pf',
                              'account.invoice',
                              mako_path,
