...
class common_report_header(object):
    ...
    def _get_start_date(self, data):
        if data.get('form', False) and data['form'].get('date_from', False):
            ...
            return pooler.get_pool(self.cr.dbname).get('account.period').browse(self.cr,self.uid,data['form']['period_from']).date_start
        elif data.get('form', False) and data['form'].get('fiscalyear_id', False) and data['form'].get('filter', False) == 'filter_no':
    ...
    def _get_end_date(self, data):
        if data.get('form', False) and data['form'].get('date_to', False):
            ...
            return pooler.get_pool(self.cr.dbname).get('account.period').browse(self.cr, self.uid, data['form']['period_to']).date_stop
        elif data.get('form', False) and data['form'].get('fiscalyear_id', False) and data['form'].get('filter', False) == 'filter_no':
            return pooler.get_pool(self.cr.dbname).get('account.fiscalyear').browse(self.cr, self.uid, data['form']['fiscalyear_id']).date_stop
        return ''
